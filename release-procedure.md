...
Check the [Finnix issue tracker](https://forge.colobox.com/finnix/finnix/issues) and see if there are any issues which can be solved before the release.
...
```shell
killall strace
git clone --depth=1 https://forge.colobox.com/finnix/finnix-live-build
...
Edit [finnix-tracker](https://forge.colobox.com/finnix/finnix-tracker)/`finnix-tracker.js`, add to `allowedHashes`.

Commit, push, [build Docker image](https://forge.colobox.com/finnix/finnix-tracker/actions/workflows/registry.yml), image pull, restart container.
...
Make sure the OpenPGP signature (`finnix-${FINNIX_VER?}.iso.gpg`) and SSH signature (`finnix-${FINNIX_VER?}.iso.sig`) are in the same directory as the ISO. Then, in the [finnix-docs](https://forge.colobox.com/finnix/finnix-docs) clone:
...
SPDX-PackageSupplier: Ryan Finnie <ryan@finnie.org>
SPDX-PackageDownloadLocation: https://forge.colobox.com/finnix/finnix-docs
...
This will kick off an official-looking "Finnix ${FINNIX_VER?}" GHA build, but in the [ci workflow](https://forge.colobox.com/finnix/finnix-live-build/actions/workflows/ci.yml), not the release workflow.
...
Go to the [Finnix issue tracker](https://forge.colobox.com/finnix/finnix/issues) and close out:
...
For the example configuration in [finnix-mirrors-website](https://forge.colobox.com/finnix/finnix-mirrors-website):
...
* [ ] [Release fitness](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#release-fitness)
* [ ] [SquashFS sort files](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#squashfs-sort-files)
* [ ] [Release build](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#release-build)
* [ ] [Release source build](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#release-source-build)
* [ ] [Release testing](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#release-testing)
  * [ ] Default UEFI VM boot
  * [ ] Default BIOS VM boot
  * [ ] Real hardware - USB
  * [ ] Real hardware - CD
  ...
  * [ ] Kernel command line: `toram`
  * [ ] `wifi-connect` usability
* [ ] [Signatures](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#signatures)
  * [ ] OpenPGP
  * [ ] SSH
* [ ] [Torrent](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#torrent)
  * [ ] File creation
  * [ ] Tracker
* [ ] [Upload](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#upload)
  * [ ] Archive
  * [ ] Internet Archive
* [ ] [Release data](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#release-data)
  * [ ] Build
  * [ ] Push
* [ ] [Finalize branch](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#finalize-branch)
* [ ] [Documentation / site updates](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#documentation--site-updates)
* [ ] [Issue management](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#issue-management)
* [ ] [Mirrors](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#mirrors)
* [ ] [Cleanup](https://forge.colobox.com/finnix/finnix-docs/blob/main/release-procedure.md#cleanup)
